...
class _GerenciarFilaScreenState extends State<GerenciarFilaScreen> {
        ...
        return AlertDialog(
          ...
          content: SizedBox(
            ...
            child: DropdownSearch<Map<String, dynamic>>(
              ...
              itemAsString: (Map<String, dynamic> cliente) => cliente['nome_display'] ?? '',
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                if (clienteSelecionado != null) {
                  ...
                  ).then((_) => _carregarDetalhesFila()); // Recarrega os detalhes ao voltar
                }
              },
            ),
          ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Gerenciar Fila #${widget.filaNumero}'),
      ),
      body: FutureBuilder<Map<String, dynamic>>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError || snapshot.data == null || snapshot.data!['success'] == false) {
            return Center(child: Text('Erro ao carregar detalhes: ${snapshot.data?['message'] ?? snapshot.error}'));
          }

          final fila = snapshot.data!['data'];
          final clientes = List<Map<String, dynamic>>.from(fila['clientes'] ?? []);

          if (clientes.isEmpty) {
            return const Center(child: Text('Nenhum cliente nesta fila ainda.'));
          }
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final produtos = List<Map<String, dynamic>>.from(cliente['produtos'] ?? []);
